    ...
    switch (type) {
      case "backlog":
        ...
        if (orderValue === "priority") {
          backlogGroupFilterdRes?.sort((a, b) => b.priority - a.priority);
        } else {
      ...
      case "todo":
        ...
        if (orderValue === "priority") {
          todoGroupFilterdRes?.sort((a, b) => b.priority - a.priority);
        } else {
      ...
      case "in progress":
        ...
        if (orderValue === "priority") {
          inProgressGroupFilterdRes?.sort((a, b) => b.priority - a.priority);
        } else {
      ...
      case "done":
        ...
        if (orderValue === "priority") {
          doneGroupFilterdRes?.sort((a, b) => b.priority - a.priority);
        } else {
      ...
      case "canceled":
        ...
        if (orderValue === "priority") {
          canceledGroupFilterdRes?.sort((a, b) => b.priority - a.priority);
        } else {
