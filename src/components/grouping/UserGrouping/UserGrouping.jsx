    ...
    switch (type) {
      case "usr-1":
        ...
        if (orderValue === "priority") {
          userOneGroupFilterdRes?.sort((a, b) => b.priority - a.priority);
        } else {
      ...
      case "usr-2":
        ...
        if (orderValue === "priority") {
          userTwoGroupFilterdRes?.sort((a, b) => b.priority - a.priority);
        } else {
      ...
      case "usr-3":
        ...
        if (orderValue === "priority") {
          userThreeGroupFilterdRes?.sort((a, b) => b.priority - a.priority);
        } else {
      ...
      case "usr-4":
        ...
        if (orderValue === "priority") {
          userFourGroupFilterdRes?.sort((a, b) => b.priority - a.priority);
        } else {
      ...
      case "usr-5":
        ...
        if (orderValue === "priority") {
          userFiveGroupFilterdRes?.sort((a, b) => b.priority - a.priority);
        } else {
