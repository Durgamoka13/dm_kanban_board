    ...
    switch (type) {
      case "no_priority":
        ...
        if (orderValue === "priority") {
          noPriorityGroupFilterdRes?.sort((a, b) => b.priority - a.priority);
        } else {
      ...
      case "urgent":
        ...
        if (orderValue === "priority") {
          urgentGroupFilterdRes?.sort((a, b) => b.priority - a.priority);
        } else {
      ...
      case "high":
        ...
        if (orderValue === "priority") {
          highGroupFilterdRes?.sort((a, b) => b.priority - a.priority);
        } else {
      ...
      case "medium":
        ...
        if (orderValue === "priority") {
          mediumGroupFilterdRes?.sort((a, b) => b.priority - a.priority);
        } else {
      ...
      case "low":
        ...
        if (orderValue === "priority") {
          lowGroupFilterdRes?.sort((a, b) => b.priority - a.priority);
        } else {
